...
#define PRESS_RATIO 0.6 //只有在基波和谐波的幅值都超过了训练数据的这个比例，才认为是按了这个键
#define PRESS_RATIO_2 0.35 //如果前一个时刻按下了这个音符，则在第二个时刻，只需超过一个更低的比例，就可以认为是按下了这个键
#define MAX_FREQ 3000 //最高分析到多高的频率
...
extern vector<int> LastNoteIndexes; //上一次认定的音符峰值点
